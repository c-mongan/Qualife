...
class ClearCurvedNavBar extends StatefulWidget {
  ...
  @override
  _ClearCurvedNavBarState createState() => _ClearCurvedNavBarState();
}

class _ClearCurvedNavBarState extends State<ClearCurvedNavBar> {
  //- - - - - - - - - instructions - - - - - - - - - - - - - - - - - -
